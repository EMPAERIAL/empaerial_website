...
import {
  ...
  sectionEditorBox, listContainer, scrollList, miniHeader,
  listItem, deleteButton, editButton,
  thumbBox, thumbImg, thumbClose,
} from "@/app/admin/adminStyles"
import {
  toTitleCaseNoUnderscore, generateSlug,
  normalizeKeyValueSection,
  DEFAULT_SPECS_ROWS, DEFAULT_MATERIALS_ROWS,
} from "@/Lib/adminUtils"
...
export default function ProjectEditor({ projects, onProjectsChange }) {
  ...
  const handleProjectSubmit = async (e) => {
    ...
    try {
      ...
      if (form.id) onProjectsChange(projects.map(p => (p.id === form.id ? updated : p)))
